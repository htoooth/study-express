...
app.lazyrouter = function lazyrouter() {
  if (!this._router) {
    ...
    this._router.use(query(this.get('query parser fn'))); // 第一个中间件，解析 url 中的 query
    this._router.use(middleware.init(this));//第二个中间件
  }
};
...
app.use = function use(fn) {
  ...
  fns.forEach(function (fn) {
    ...
    // mounted an app
    fn.emit('mount', this);  //发出挂载事件，这个this 是parent
  }, this);
...
// 调用的地方
app.listen = function listen() { // 启动应用
